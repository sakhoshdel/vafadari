...
function jd_to_persian(e) {
  ...
  return (
    ...
    1029982 == o
      ...
      : ((l = Math.floor(o / 366)),
        (u = mod(o, 366)),
        (s = Math.floor((2134 * l + 2816 * u + 2815) / 1028522) + l + 1)),
    (t = s + 2820 * a + 474) <= 0 && t--,
...
function JalaliDate(e, t, n) {
  ...
  function a(e) {
    return (
      ...
      (o = new Date(e)).setHours(o.getHours() > 12 ? o.getHours() + 2 : 0),
      (o && "Invalid Date" != o && !isNaN(o || !o.getDate())) ||
        (o = new Date()),
      (s = r([o.getFullYear(), o.getMonth(), o.getDate()])),
      this
    );
  }
  var o, s;
  ...
  (this.getGregorianDate = function () {
    ...
    (this.setMonth = function (e) {
      s[1] = e;
      var t = i(s);
      (o = new Date(t[0], t[1], t[2])), (s = r([t[0], t[1], t[2]]));
    }),
...
!(function (e, t) {
    ...
    if (ue.acceptData(e)) {
      ...
      if ((c && u[c] && (r || u[c].data)) || i !== t || "string" != typeof n)
        return (
          ...
          i !== t && (o[ue.camelCase(n)] = i),
          "string" == typeof n
            ? null == (a = o[n]) && (a = o[ue.camelCase(n)])
            : (a = o),
          a
        );
    }
    ...
    if (ue.acceptData(e)) {
      ...
      if (o[l]) {
        ...
        (n || (delete o[l].data, s(o[l]))) &&
          (a
            ? ue.cleanData([e], !0)
            : ue.support.deleteExpando || o != o.window
            ? delete o[l]
            : (o[l] = null));
      }
    }
  ...
  function b(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        ...
        for (i in ((r = ue._data(t)), r.events)) ue.removeEvent(t, i, r.handle);
  ...
  function _(e, n) {
    ...
    if (!o)
      for (o = [], i = e.childNodes || e; null != (r = i[a]); a++)
        !n || ue.nodeName(r, n) ? o.push(r) : ue.merge(o, _(r, n));
  ...
  function w(e, t) {
    for (var n, i, r, a = [], o = 0, s = e.length; s > o; o++)
      (i = e[o]).style &&
        ((a[o] = ue._data(i, "olddisplay")),
        (n = i.style.display),
        t
          ? (a[o] || "none" !== n || (i.style.display = ""),
            "" === i.style.display &&
              D(i) &&
              (a[o] = ue._data(i, "olddisplay", M(i.nodeName))))
          : a[o] ||
            ((r = D(i)),
            ((n && "none" !== n) || !r) &&
  ...
  function T(e, t, n, i, r) {
    for (
      ...
      "margin" === n && (o += ue.css(e, n + xt[a], !0, r)),
        i
          ? ("content" === n && (o -= ue.css(e, "padding" + xt[a], !0, r)),
            "margin" !== n &&
              (o -= ue.css(e, "border" + xt[a] + "Width", !0, r)))
          : ((o += ue.css(e, "padding" + xt[a], !0, r)),
            "padding" !== n &&
              (o += ue.css(e, "border" + xt[a] + "Width", !0, r)));
    return o;
  }
  function N(e, t, n) {
    ...
    if (0 >= r || null == r) {
      if (
        ...
        return r;
      (i = o && (ue.support.boxSizingReliable || r === e.style[t])),
        (r = parseFloat(r) || 0);
    }
    ...
    return (
      n ||
        (("none" !== (n = S(e, t)) && n) ||
          ...
          (t = (st[0].contentWindow || st[0].contentDocument).document).write(
  ...
  function I(e, n, i) {
    for (var r, a, o, s, l = e.contents, u = e.dataTypes; "*" === u[0]; )
      u.shift(),
    ...
    return o ? (o !== u[0] && u.unshift(o), i[o]) : t;
  }
  function F(e, t, n, i) {
    var r,
      a,
  ...
  function P(e, t, n) {
    for (
      var i, r = (tn[t] || []).concat(tn["*"]), a = 0, o = r.length;
      o > a;
      a++
    )
  ...
  function R(e, t, n) {
    var i,
      ...
      c = u.props;
    for (Y(c, u.opts.specialEasing); o > a; a++)
  ...
  (ue.fn = ue.prototype =
              ...
              (e = s[r]),
                ...
                s !== i &&
                  (c && i && (ue.isPlainObject(i) || (n = ue.isArray(i)))
                    ? (n
                        ? ((n = !1), (o = e && ue.isArray(e) ? e : []))
                        : (o = e && ue.isPlainObject(e) ? e : {}),
                      (s[r] = ue.extend(c, o, i)))
                    : i !== t && (s[r] = i));
        return s;
      }),
    ue.extend({
      ...
      isPlainObject: function (e) {
        ...
        if (ue.support.ownLast) for (n in e) return se.call(e, n);
        for (n in e);
      ...
      each: function (e, t, i) {
        var r = 0,
          ...
          o = n(e);
        if (i) {
          if (o) for (; a > r && !1 !== t.apply(e[r], i); r++);
          else for (r in e) if (!1 === t.apply(e[r], i)) break;
        } else if (o) for (; a > r && !1 !== t.call(e[r], r, e[r]); r++);
      ...
      map: function (e, t, i) {
        var r,
          ...
          s = [];
        if (n(e))
          for (; o > a; a++) null != (r = t(e[a], a, i)) && (s[s.length] = r);
        else for (a in e) null != (r = t(e[a], a, i)) && (s[s.length] = r);
        return ne.apply([], s);
      },
      guid: 1,
      proxy: function (e, n) {
      ...
      access: function (e, n, i, r, a, o, s) {
        var l = 0,
          ...
          c = null == i;
        if ("object" === ue.type(i))
          for (l in ((a = !0), i)) ue.access(e, n, l, i[l], !0, o, s);
        else if (
          r !== t &&
          ((a = !0),
          ue.isFunction(r) || (s = !0),
        ...
        return (
          ...
          r(function (r, o, s, l) {
            var u,
              ...
              y = !e || (!r && t) ? m : f(m, p, e, s, l),
              b = n ? (a || (r ? e : g || i) ? [] : o) : y;
            if ((n && n(y, b, s, l), i))
              for (u = f(b, h), i(u, [], s, l), c = u.length; c--; )
                (d = u[c]) && (b[h[c]] = !(y[h[c]] = d));
            if (r) {
              if (a || e) {
                if (a) {
            ...
            } else (b = f(b === o ? b.splice(g, b.length) : b)), a ? a(null, o, b, l) : Q.apply(o, b);
          })
        );
      }
      function m(e) {
        for (
          ...
          if ((n = D.relative[e[s].type])) c = [p(h(c), n)];
          else {
            if ((n = D.filter[e[s].type].apply(null, e[s].matches))[H]) {
        ...
        var i = 0,
          ...
          s = function (r, s, l, u, c) {
            var d,
              ...
              b = null != c,
              _ = N,
              x = r || (o && D.find.TAG("*", (c && s.parentNode) || s)),
              w = (P += null == _ ? 1 : Math.random() || 0.1);
            for (b && ((N = s !== $ && s), (k = i)); null != (d = x[y]); y++) {
              if (o && d) {
                for (p = 0; (h = e[p++]); )
                  if (h(d, s, l)) {
                    u.push(d);
      ...
      function b(e, t, n, i) {
        ...
        if (!i && 1 === u.length) {
          if (
            ...
            if (!(t = (D.find.ID(o.matches[0].replace(xe, ke), t) || [])[0]))
              return n;
            e = e.slice(a.shift().value.length);
          }
          for (
            r = ge.needsContext.test(e) ? 0 : a.length;
            r-- && ((o = a[r]), !D.relative[(s = o.type)]);
              ...
              return 1 === i && 0 === r
                ...
                : function (t, n, l) {
                    ...
                    if (m) {
                      ...
                      if (((f = [o ? m.firstChild : m.lastChild]), o && v)) {
                        for (
                          h =
                            (u = (c = m[H] || (m[H] = {}))[e] || [])[0] === P &&
                            u[1],
  ...
  (ue.Callbacks = function (e) {
    var n,
      ...
      d = function (t) {
        for (
          r = e.memory && t, a = !0, s = l || 0, l = 0, o = u.length, n = !0;
          u && o > s;
          s++
        )
    ...
    (ue.support = (function (t) {
      ...
      if (
        ...
        return t;
      (s = (a = G.createElement("select")).appendChild(
      ...
      for (c in ((r = G.createElement("input")).setAttribute("value", ""),
      ...
      (o = G.createDocumentFragment()).appendChild(r),
      ...
      return (
        ...
        ue(function () {
          ...
          o &&
            ...
            ue.swap(o, null != o.style.zoom ? { zoom: 1 } : {}, function () {
  ...
  ue.extend({
    ...
    hasData: function (e) {
      return (
        !!(e = e.nodeType ? ue.cache[e[ue.expando]] : e[ue.expando]) && !s(e)
      );
    },
    data: function (e, t, n) {
      return r(e, t, n);
        ...
        if (e === t) {
          if (
            ...
            for (i = l.attributes; i.length > s; s++)
              0 === (r = i[s].name).indexOf("data-") &&
                ((r = ue.camelCase(r.slice(5))), o(l, r, a[r]));
    ...
    ue.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, r = e.options, a = ue.makeArray(t), o = r.length;
              o--;
          ...
          ? function (e, n, r) {
              var a = ue.expr.attrHandle[n],
                o = r
                  ...
                  ? n.toLowerCase()
                  : null;
              return (ue.expr.attrHandle[n] = a), o;
            }
          : function (e, n, i) {
              return i
                ? t
  ...
  (ue.event = {
    ...
    trigger: function (n, i, r, a) {
      ...
      if (
        ...
        if (
          ...
          (d = r[s]) && (r[s] = null), (ue.event.triggered = f);
          try {
            r[f]();
          } catch (e) {}
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ue.event.handlers.call(this, e, u), n = 0;
          (a = s[n++]) && !e.isPropagationStopped();

        )
          for (
            e.currentTarget = a.elem, o = 0;
            (r = a.handlers[o++]) && !e.isImmediatePropagationStopped();
    ...
    ue.fn.extend({
      on: function (e, n, i, r, a) {
        var o, s;
        if ("object" == typeof e) {
          for (o in ("string" != typeof n && ((i = i || n), (n = t)), e))
            this.on(o, n, i, e[o], a);
          return this;
        }
        if (
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          r = this.length,
          a = [],
          o = We.test(e) || "string" != typeof e ? ue(e, t || this.context) : 0;
        r > i;
        i++
      )
  ...
  (at.optgroup = at.option),
    ...
    ue.fn.extend({
      ...
      domManip: function (e, t, n) {
        ...
        if (
          ...
          for (a = (o = ue.map(_(l, "script"), g)).length; c > u; u++)
            (r = l),
              u !== p &&
                ((r = ue.clone(r, !0, !0)), a && ue.merge(o, _(r, "script"))),
              t.call(this[u], r, u);
          if (a)
            for (
              s = o[o.length - 1].ownerDocument, ue.map(o, m), u = 0;
              a > u;
              u++
            )
              (r = o[u]),
    ...
    ue.each(
      ...
      function (e, t) {
        ue.fn[e] = function (e) {
          for (var n, i = 0, r = [], a = ue(e), o = a.length - 1; o >= i; i++)
    ...
    ue.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (i = _(a), s = _(e), o = 0; null != (r = s[o]); ++o)
            i[o] && b(r, i[o]);
        if (t)
          if (n)
            for (s = s || _(e), i = i || _(a), o = 0; null != (r = s[o]); o++)
              v(r, i[o]);
          else v(e, a);
        return (
      ...
      buildFragment: function (e, t, n, i) {
        for (
          var r, a, o, s, l, u, c, d = e.length, p = h(t), f = [], g = 0;
          d > g;
          g++
        )
          if ((a = e[g]) || 0 === a)
            if ("object" === ue.type(a)) ue.merge(f, a.nodeType ? [a] : a);
              ...
              for (
                s = s || p.appendChild(t.createElement("div")),
                  ...
                  c = at[l] || at._default,
                  s.innerHTML = c[1] + a.replace(Ge, "<$1></$2>") + c[2],
                  r = c[0];
                r--;
              ...
              if (
                ...
                for (
                  ...
                  ue.nodeName((u = a.childNodes[r]), "tbody") &&
                    ...
                    a.removeChild(u);
              for (
                ue.merge(f, s.childNodes), s.textContent = "";
                s.firstChild;
        ...
        for (
          ...
          if (
            (!i || -1 === ue.inArray(a, i)) &&
            ((o = ue.contains(a.ownerDocument, a)),
            (s = _(p.appendChild(a), "script")),
            o && y(s),
            n)
          )
            for (r = 0; (a = s[r++]); ) nt.test(a.type || "") && n.push(a);
        return (s = null), p;
      },
      cleanData: function (e, t) {
        for (
          ...
          if ((t || ue.acceptData(n)) && ((r = n[s]), (a = r && l[r]))) {
            if (a.events)
              for (i in a.events)
      ...
      style: function (e, n, i, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            return s && "get" in s && (a = s.get(e, !1, r)) !== t ? a : u[n];
          if (
            ("string" == (o = typeof i) &&
              (a = yt.exec(i)) &&
      ...
      css: function (e, n, i, r) {
        ...
        return (
          ...
          (s = ue.cssHooks[n] || ue.cssHooks[l]) &&
            ...
            (o = s.get(e, !0, i)),
          o === t && (o = ut(e, n, r)),
          "normal" === o && n in _t && (o = _t[n]),
          "" === i || i
            ? ((a = parseFloat(o)), !0 === i || ue.isNumeric(a) ? a || 0 : o)
            : o
        );
      },
    }),
        ...
        (ut = function (e, n, i) {
          ...
          return (
            ...
            mt.test(l) &&
              ...
              ((r = u.left),
              (a = e.runtimeStyle),
              (o = a && a.left) && (a.left = e.currentStyle.left),
  ...
  (Mt = Ot.exec(St.toLowerCase()) || []),
    ...
    ue.extend({
      ...
      ajax: function (e, n) {
            ...
            a
              ? (p.ifModified &&
                  ((x = k.getResponseHeader("Last-Modified")) &&
                    (ue.lastModified[o] = x),
                  (x = k.getResponseHeader("etag")) && (ue.etag[o] = x)),
                204 === e || "HEAD" === p.type
                  ? (D = "nocontent")
                  : 304 === e
                  ? (D = "notmodified")
        ...
        p.ifModified &&
          (ue.lastModified[o] &&
            k.setRequestHeader("If-Modified-Since", ue.lastModified[o]),
          ue.etag[o] && k.setRequestHeader("If-None-Match", ue.etag[o])),
        ...
        p.headers))
          k.setRequestHeader(a, p.headers[a]);
        if (p.beforeSend && (!1 === p.beforeSend.call(h, k, p) || 2 === _))
          return k.abort();
        for (a in ((x = "abort"), { success: 1, error: 1, complete: 1 }))
          k[a](p[a]);
        if ((c = E(Yt, p, n, k))) {
          (k.readyState = 1),
      ...
      return l || "jsonp" === n.dataTypes[0]
        ? ((a = n.jsonpCallback =
          ...
          (n.converters["script json"] = function () {
            return s || ue.error(a + " was not called"), s[0];
          }),
          (n.dataTypes[0] = "json"),
          (o = e[a]),
          (e[a] = function () {
              ...
              l.send((n.hasContent && n.data) || null),
                ...
                n.async
                  ? 4 === l.readyState
                    ? setTimeout(i)
                    : ((o = ++Ut),
                      Xt && (zt || ((zt = {}), ue(e).unload(Xt)), (zt[o] = i)),
    ...
    en = [
      function (e, t, n) {
        var i,
          ...
          h = ue._data(e, "fxshow");
        for (i in (n.queue ||
          (null == (s = ue._queueHooks(e, "fx")).unqueued &&
            ((s.unqueued = 0),
            (l = s.empty.fire),
        ...
        if (!ue.isEmptyObject(c))
          ...
          u.done(function () {
            var t;
            for (t in (ue._removeData(e, "fxshow"), c)) ue.style(e, t, c[t]);
          }),
          c))
            (o = P(p ? h[i] : 0, i, u)),
              i in h ||
      ...
      stop: function (e, n, i) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (n in o) o[n] && o[n].stop && Zt.test(n) && r(o[n]);
            for (n = a.length; n--; )
              a[n].elem !== this ||
                (null != e && a[n].queue !== e) ||
...
!(function ($, undefined) {
  ...
  function extendRemove(e, t) {
    for (var n in ($.extend(e, t), t)) null == t[n] && (e[n] = t[n]);
    return e;
  }
  ...
  $.extend(Datepicker.prototype, {
      ...
      (i = t || {}),
        ...
        s &&
          ...
          null !== a &&
            ...
            i.minDate === undefined &&
            (s.settings.minDate = this._formatDate(s, a)),
          null !== o &&
            i.dateFormat !== undefined &&
            i.maxDate === undefined &&
            (s.settings.maxDate = this._formatDate(s, o)),
          "disabled" in i &&
            (i.disabled
    ...
    _doKeyDown: function (e) {
      ...
      if (((r._keyEvent = !0), $.datepicker._datepickerShowing))
        switch (e.keyCode) {
          ...
          case 37:
            (e.ctrlKey || e.metaKey) &&
              $.datepicker._adjustDate(e.target, o ? 1 : -1, "D"),
              (a = e.ctrlKey || e.metaKey),
    ...
    _showDatepicker: function (e) {
      ...
      $.datepicker._isDisabledDatepicker(e) || $.datepicker._lastInput === e) ||
        ...
        !1 !==
          ...
          t.inline ||
            ((o = $.datepicker._get(t, "showAnim")),
            (s = $.datepicker._get(t, "duration")),
            t.dpDiv.zIndex($(e).zIndex() + 1),
            ($.datepicker._datepickerShowing = !0),
            $.effects && $.effects.effect[o]
              ? t.dpDiv.show(o, $.datepicker._get(t, "showOptions"), s)
              : t.dpDiv[o || "show"](o ? s : null),
    ...
    _checkOffset: function (e, t, n) {
      ...
      return (
        ...
        (t.left -= Math.min(
          t.left,
          t.left + i > s && s > i ? Math.abs(t.left + i - s) : 0
        )),
        (t.top -= Math.min(
          t.top,
    ...
    parseDate: function (e, t, n) {
          ...
          var n = b(e),
            i =
              "@" === e
                ...
                : 2,
            r = new RegExp("^\\d{1," + i + "}"),
            a = t.substring(s).match(r);
          if (!a) throw "Missing number at position " + s;
          return (s += a[0].length), parseInt(a[0], 10);
        },
        x = function (e, n, i) {
          var r = -1,
          ...
          if (
            ($.each(a, function (e, n) {
              var i = n[1];
              if (t.substr(s, i.length).toLowerCase() === i.toLowerCase())
                return (r = n[0]), (s += i.length), !1;
            }),
            -1 !== r)
          )
            return r + 1;
        ...
        if (v) "'" !== e.charAt(i) || b("'") ? k() : (v = !1);
          ...
          switch (e.charAt(i)) {
            ...
            case "y":
              ...
              break;
            case "@":
              (f = (o = new this.CDate(_("@"))).getFullYear()),
                (g = o.getMonth() + 1),
                (m = o.getDate());
              break;
            case "!":
      ...
      if (s < t.length && ((a = t.substr(s)), !/^\s+/.test(a)))
      ...
      if (
        ...
        for (g = 1, m = y; (r = this._getDaysInMonth(f, g - 1)), !(m <= r); )
          g++, (m -= r);
      if (
      ...
      var i =
        null == t || "" === t
          ...
          ? isNaN(t)
            ? n
            : (function (e) {
                return this.CDate, t.setDate(t.getDate() + e), t;
              })(t)
          : new Date(t.getTime());
      return (
    ...
    _generateHTML: function (e) {
      ...
      for (
        e.drawMonth = Q,
          ...
          s = this._get(e, "gotoCurrent") && e.currentDay ? G : P,
  ...
  $(document).ready(function () {
    let e = jQuery || {};
    "undefined" != typeof django && (e = django.jQuery),
      e(".jalali_date-date").datepicker({
        dateFormat: "yy-mm-dd",
        changeMonth: !0,
        changeYear: !0,
      }),
